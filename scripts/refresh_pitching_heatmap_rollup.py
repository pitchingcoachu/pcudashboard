...
WITH base_non_pro AS (
  ...
  SELECT
    session_date, school_code, pitcher_norm, batterside_norm,
  ...
  SELECT
    session_date, school_code, session_type_bucket, pitcher_norm, pitcher_team_code, batterside_norm,
...
SELECT
  a.session_date, a.school_code, a.session_type_bucket, a.pitcher_norm, a.pitcher_team_code, a.batterside_norm,
