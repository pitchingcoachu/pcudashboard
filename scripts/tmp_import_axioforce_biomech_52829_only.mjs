...
const ALL_PITCH_DIR = path.join(ROOT, 'All pitch CSVs', '5:28-29');
const SINGLE_PITCH_DIR = path.join(ROOT, 'Single Pitch CSVs', '5:28-29');
...
async function main() {
  ...
  try {
    ...
    console.log(`found single-pitch files: ${singleFiles.length}`);let allRowsInserted = 0;
