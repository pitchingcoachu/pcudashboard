...
export function resolveAllowedDashboardSchoolCodes(): string[] {
  ...
  const combined = Array.from(
    new Set([...envValues, ...mapValues, fallback, 'PCU', 'TRIAL', 'OSU', 'CNU', 'GCU', 'GMU', 'LSU', 'UNM', 'UNOH', 'LEC', 'GUND', 'SEMO', 'CREIGHTON', 'HARVARD', 'CBU', 'ARIZONA', 'LI', 'INDY', 'LEAGUE', 'PRO', 'BC'].filter(Boolean))
  );
  return combined;
}
