...
Tool usage guidance:
- Before calling get_player_stat, get_leaderboard, or compare_splits with a metric name you are not fully certain maps onto a table column, call search_metrics first to resolve the canonical name.
