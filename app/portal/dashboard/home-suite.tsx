...
export default function HomeSuite({ role, selectedSchoolCode, activeSuite, suiteOptions, onOpenSuite, onNavigate }: HomeSuiteProps) {
  ...
  const isLongIslandSchool = normalizedSchoolCode === 'LI';
  const isHeavySchool = isProSchool || isLeagueSchool || isIndySchool || isLongIslandSchool;
  ...
  function resolveHeavyLeaderboardWindow(): { startDate: string; endDate: string } {
    ...
    if (isLongIslandSchool || isIndySchool) return { startDate: '2026-04-01', endDate };
