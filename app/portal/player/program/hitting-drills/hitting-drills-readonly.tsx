...
import type { DrillSectionState, HittingDrillsState } from '../../../../../lib/hitting-drills-program';
  ...
  return (
    <section className="portal-panel portal-drills-section">
      ...
      <div className="portal-table-wrap">
        <table className="portal-drills-table portal-drills-table-readonly portal-hitting-drills-table">
          <colgroup>
...
export default function HittingDrillsReadonly({
  state,
  drillVideos,
  playerId,
}: {
  state: HittingDrillsState;
