...
const nextConfig: NextConfig = {
  ...
  // @ffmpeg-installer/ffmpeg and @resvg/resvg-js both resolve a
  // platform-specific native binary via a dynamic require() the bundler
  // can't statically analyze -- bundling either produces a resolution
  // error ("could not resolve ... into a module", confirmed for
  // @resvg/resvg-js-darwin-arm64 under Turbopack dev). Both are used
